            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Text('Cari buku, penulis, atau genre...',
                      style: TextStyle(
    ...
    return Padding(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final dipinjam = snapshot.data?.docs
                  .where((d) =>
                      (d.data() as Map)['status'] == 'Dipinjam')
                  .length ??
              0;
          ...
          return GridView.count(
            ...
            children: [
              _buildStatCard('Total Buku', '$total',
                  Icons.library_books, Colors.blue),
              _buildStatCard('Dipinjam', '$dipinjam',
                  Icons.import_contacts, Colors.orange),
              _buildStatCard('Tersedia', '$tersedia',
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildMenuItem(context, 'Cari Buku',
                  Icons.search_outlined, Colors.blue,
                  onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const SearchScreen()))),
              _buildMenuItem(context, 'Lokasi',
              ...
              _buildMenuItem(context, 'Transaksi',
      ...
      children: [
        ...
        StreamBuilder<List<BookModel>>(
          ...
          builder: (context, snapshot) {
            ...
            return Column(
                children: books
                    .map((b) => _buildBookItem(context, b))
                    .toList());
          },
        ),
      ],
              ...
              GestureDetector(
                ...
                child: AnimatedSwitcher(
                  ...
                  child: Icon(
                    ...
                    key: ValueKey(isFav),
                    color:
                        isFav ? Colors.red : Colors.grey.shade400,
                    size: 24,
                  ),
                ),
              ),
