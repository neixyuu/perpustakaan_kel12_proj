...
class _SearchScreenState extends State<SearchScreen> {
  ...
  static const List<String> _genres = [
    'Semua', 'Sejarah', 'Budaya', 'Sastra',
    'Kuliner', 'Alam', 'Bahasa', 'Ekonomi', 'Teknologi',
  ];

  List<BookModel> _applyFilter(List<BookModel> all) {
    return all.where((b) {
      final matchGenre =
          _selectedGenre == 'Semua' || b.genre == _selectedGenre;
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<List<BookModel>>(
              stream:
                  FirestoreService.instance.getBooksStream(),
                      ...
                      children: [
                        ...
                        Text('Buku tidak ditemukan',
                            style: GoogleFonts.inter(
                                fontSize: 16,
                                color: Colors.grey.shade500)),
                        Text('Coba genre atau kata kunci lain',
                            style: GoogleFonts.inter(
                                fontSize: 13,
                    ...
                    Expanded(
                      child: AnimatedSwitcher(
                        ...
                        child: ListView.builder(
                          key: ValueKey(
                              '$_selectedGenre$_query'),
                          padding: const EdgeInsets.only(
                              bottom: 16),
                          itemCount: filtered.length,
                          itemBuilder: (_, i) =>
                              _buildBookCard(filtered[i]),
                        ),
                      ),
                    ),
                  ],
